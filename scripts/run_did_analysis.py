...
Regression: Y_change ~ treatment + post + treatment×post + covariates
...
def run_analysis(country_filter=None):
    print("=" * 70)
    ...
    # Parallel trends for key outcomes
    key_outcomes = [
        ("dw_built_pct", "Built-up (%)"),
        ("dw_crops_pct", "Cropland (%)"),
...
def main():
    ...
    run_analysis(country_filter=args.country)
